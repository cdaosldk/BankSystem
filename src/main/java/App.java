...
public class App {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("|     1. 은행 관리                       ");
            System.out.println("|     2. 거래내역 및 입출금               ");
    ...
    public static void bankManager() {
        ...
        while (true) {
            ...
            System.out.println("|     2. 등록계좌 수정/삭제                ");
            System.out.println("|     3. 계좌 조회(소유자/계좌번호/전체)     ");
...
//        String accNum = 계좌번호 호출
        while (true) {
            ...
            System.out.println("|          2. 거래 내역 조회            ");
            System.out.println("|          3. 입금/출금                ");
            System.out.println("|          4. 이전으로 이동             ");
            System.out.println("=======================================");
